...
var Options = function Options(props) {
    return _react2.default.createElement(
        ...
        props.options.map(function (option) {
            return _react2.default.createElement(_Option2.default, { key: option, option: option, remove: props.remove });
        })
    );
};
...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function componentDidMount() {
            var opt = JSON.parse(localStorage.getItem("options"));
            if (opt) {
                this.setState(function () {
                    return { options: opt };
                });
        ...
        value: function remove(option) {
            this.setState(function (currentState) {
                return {
                    options: currentState.options.filter(function (opt) {
                        return opt !== option;
                    })
                };
            });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Action2.default, { makeDecision: this.makeDecision, hasOptions: this.state.options.length > 0 }),
                _react2.default.createElement(_Options2.default, { removeAll: this.removeAll, options: this.state.options, remove: this.remove }),
